...
/**
 * Cargar datos de un usuario cuando se va a editar
 */
$editar_usuario = null;
...
?>
<!-- Encabezado -->
<div style="text-align: right; margin: 10px 5%; font-size:14px;">
    <?php
    ...
    echo " | Session Name: " . htmlspecialchars($nombreSession) . " | Session Id: " . htmlspecialchars($idSession) . " |";
    ?>
    Bienvenido, <?php echo htmlspecialchars($username); ?> | 
    <a href="ver_logs.php" style="color: blue;">Ver Auditoría de Sesiones</a> |
    ...
    <form action="conexionBD_leer_registrar_eliminar_editar_css_sesion.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="user" placeholder="Usuario" 
                   value="<?php echo $editar_usuario ? htmlspecialchars($editar_usuario['username']) : ''; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-actions">
            <input type="submit" class="btn btn-primary" 
                   name="<?php echo $editar_usuario ? 'actualizar' : 'registrar'; ?>" 
                   value="<?php echo $editar_usuario ? 'Actualizar' : 'Registrar'; ?>">
            <?php if ($editar_usuario): ?>
